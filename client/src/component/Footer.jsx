...
const Footer = () => {
  return (
   ...
   <h3 className=' text-white  mb-3' style={{wordSpacing:'1px',fontFamily:'Lato'}}>Window Innovations Best Fabricated uPVC & Aluminium</h3>
...
<div className="f-map" style={{ position: 'relative', height: '330px' }}>
  ...
  />
      ...
      <div className='c-wid mb-5' >
        ...
        <div className='mt-3'><i style={{fontSize:'28px'}} class="fa-solid fa-envelope text-warning" ></i ><span className='my-btn' style={{wordSpacing:'1px',fontFamily:'Lato'}}>Windowinnovationz678@gmail.com</span></div>
